...
class IP {
    ...
    static getRandomIPv6(ip) {
        ...
        const BASE_10_ADDR = this.normalizeIP(rawAddr), RANDOM_ADDR = new Array(8).fill(1).map(() => Math.floor(Math.random() * 0xffff)), MERGED_ADDR = RANDOM_ADDR.map((randomItem, idx) => {
