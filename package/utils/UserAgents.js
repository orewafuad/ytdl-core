...
class UserAgent {
    ...
    static tv = 'Mozilla/5.0 (X11; Linux x86_64) Cobalt/24.lts.13.1032728-gold (unlike Gecko) v8/8.8.278.8-jit gles Starboard/14, SystemIntegratorName_DESKTOP_ChipsetModelNumber_2023/FirmwareVersion (BrandName, ModelName)';
}
